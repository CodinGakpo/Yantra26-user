      ...
      if (selectedFile) {
        try {
          setIsClassifying(true);
            ...
            // Pass title and description for hybrid classification
            const mlResult = await classifyImage(
              imageBase64,
              formData.issue_title,        // ← ADD THIS
              formData.issue_description,  // ← ADD THIS
              getAuthHeaders
            );
